		  ...
		  <UL>
	       ...
	       <TD></TD>
	      	<TD>
				...
				setFormProperty("htmlform_solutions_vcs_manageUserMapping_editUserMapping_%value $index%", "isUsername", "%value devName%");
			...
			document.write('<A HREF="solutions-vcs-manageUserMapping-editUserMapping.dsp?action=edit&isUsername=%value devName%&vcsUsername=%value vcsName%">Edit</A>');
				...
				setFormProperty("htmlform_solutions_vcs_manageUserMapping_%value $index%", "isUsername", "%value devName%");
			    </script>
			    
			    <script>
		        if(is_csrf_guard_enabled && needToInsertToken) {
		     	document.write("<A class='imagelink' HREF='javascript:document.htmlform_solutions_vcs_manageUserMapping_%value $index%.submit();' onclick=\"return confirmDelete('%value -htmlcode devName%');\"><IMG SRC='../WmRoot/icons/delete.gif' alt='Delete this Package' border='0'></A>");
		       } else {
			document.write("<A class='imagelink' HREF='solutions-vcs-manageUserMapping.dsp?action=delete&isUsername=%value devName%'onclick=\"return confirmDelete('%value -htmlcode devName%');\"><IMG SRC='../WmRoot/icons/delete.gif' alt='Delete this Package' border='0'></A>");
		     }
           </script>
			  	</p>
