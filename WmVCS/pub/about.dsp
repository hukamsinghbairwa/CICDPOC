...
<html>
    ...
    <body>
        ...
        %invoke wm.vcs.admin:getStartupErrors%
                        ...
                        %scope #$key%
                            <tr class="message">
                                <td id="message">
                                    <b>
									<script>
					                createForm("htmlform_showErrorDetail", "/WmVCS/error/showErrorDetail.dsp", "POST", "BODY");
			...
			document.write('<a href=/WmVCS/error/showErrorDetail.dsp?errorMessage=%value -urlencode $key%>%value message%</a>');
		     }
           </script>
									</b>
                        ...
                        <td valign="top" width=50%>
                            <table class="table2" width=100%>
                                ...
                                <tr>
                                    ...
                                    <td class="oddrowdata" colspan=2>
									<script>
					                createForm("htmlform_showErrors", "/WmVCS/error/showErrors.dsp", "POST", "BODY");
									</script>
                                        <script>getURL("/WmVCS/error/showErrors.dsp","javascript:document.htmlform_showErrors.submit();","view");</script>
                                    </td>
                                </tr>
