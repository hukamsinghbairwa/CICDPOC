...
<html>
	...
	<div class="oddrowdata" id="goContainer" name="goContainer" style="display:none;padding-top=2mm;">
		...
		%else%		
        		<a href="/WmART/advancedListener/ListAdvancedListeners.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchListenerName=%value -urlencode searchListenerName%&prev=true&dspName=.LISTADVANCEDLISTENERS">&laquo; Previous</a>&nbsp;<label class="evenrowdata-l">Page (1-
