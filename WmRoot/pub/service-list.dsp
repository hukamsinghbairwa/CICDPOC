            ...
            <TR>
			  ...
			  <script>
					if(is_csrf_guard_enabled && needToInsertToken) {
						document.write('<A HREF="javascript:document.htmlform_service_list_interface.submit();" onClick="return populateForm(document.htmlform_service_list_interface, \'interface=%value fullname%\')"><IMG src="icons/dir.png" border=0></A>');
					} else {
						document.write('<A HREF="service-list.dsp?interface=%value fullname%"><IMG src="icons/dir.png" border=0></A>');
					}
				</script>			  
			  &nbsp;
      ...
      <TR>
        <script>writeTD("rowdata-l");</script>
         ...
         <nobr>
		    <script>
				if(is_csrf_guard_enabled && needToInsertToken) {
					document.write('<A HREF="javascript:document.htmlform_service_info_browse_folders.submit();" onClick="return populateForm(document.htmlform_service_info_browse_folders, \'service=%value /interface%:%value name%;browsefolders=true\')"><IMG src="icons/file.png" border=0></A>');
				} else {
					document.write('<A HREF="service-info.dsp?service=%value /interface encode(url)%:%value name encode(url)%&browsefolders=true"><IMG src="icons/file.png" border=0></A>');
				}
			</script>
		 &nbsp;
			<script>
        ...
        <script>writeTD("rowdata");</script>
			<script>
				if(is_csrf_guard_enabled && needToInsertToken) {
					document.write('<A href="javascript:document.htmlform_service_test.submit();" onClick="return populateForm(document.htmlform_service_test, \'interface=%value /interface%;service=%value name%\')"><IMG src="icons/checkdot.png" border=0></A>');
				} else {
					document.write('<A href="service-test.dsp?interface=%value /interface encode(url)%&service=%value name encode(url)%"><IMG src="icons/checkdot.png" border=0> </A>');
				}
			</script>
