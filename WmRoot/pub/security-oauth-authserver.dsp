    ...
    %endif%
      ...
      <TR> 
        ...
        <TABLE width="70%" class="tableView">
			...
			<TR>
				<TD class="oddrow">Introspection Endpoint</TD>
			...
			<TR>
				<!-- TODO: make this a secure password field ??? -->
				<TD class="oddrow">Client Secret</TD>
				<TD class="oddrow-l"><INPUT NAME="client_secret" ID="client_secret" %ifvar action equals('edit')%value="%value client_secret encode(htmlattr)%"%endif%> </TD> 
			</TR>
			<!-- subUserLookup -->
			<TR>
				<SCRIPT>
				...
				<TD class="oddrow-l">
					...
					<a class="submodal" href="subUserLookup"><img border=0 align="bottom" src="icons/magnifyglass.png"/></a>
				</TD>
			</TR>
			<!-- End subUserLookup -->
            <TR>
                ...
                <TD class="evenrowdata-l">
                    <SELECT class="listbox" name="keystoreAlias" onchange="updateKeyAlias()"></SELECT>
                </TD>
            </TR>
            <TR>
