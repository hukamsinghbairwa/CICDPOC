    ...
    <form name="editform" action="settings-jms-detail.dsp" METHOD="POST">
      ...
      <td>
        ...
        <div id="div1" STYLE="display: none">
          ...
          <tr>
            <td class="oddrow-l">Create Administered Objects On Demand (Universal Messaging)</td>
            %ifvar jndi_automaticallyCreateUMAdminObjects equals('true')%
             <td class="oddrow-l"><input type="checkbox" name="jndi_automaticallyCreateUMAdminObjects" checked=true></td>
            %else%
             <td class="oddrow-l"><input type="checkbox" name="jndi_automaticallyCreateUMAdminObjects"></td>
            %endif%
            </td>
          </tr>
          
          <tr>
            <td class="oddrow-l">Enable Follow the Master (Universal Messaging)</td>
            %ifvar jndi_enableFollowTheMaster equals('true')%
              <script>writeTD("oddrowdata-l");</script><input type="checkbox" name="jndi_enableFollowTheMaster" checked="true">
            %else%
              <script>writeTD("oddrowdata-l");</script><input type="checkbox" name="jndi_enableFollowTheMaster">
            %endif%
          </tr>
        ...
        <table class="tableView" width="100%">
         ...
         <tr>
          ...
          <script>swapRows();</script>
          <tr>  
            <script>writeTDWidth("row-l", "40%");</script>Enable Destination Management with Designer (Broker and Universal Messaging)</td>
