...
<TR valign=top>
   ...
   <script>
	...
	<script>
		        if(is_csrf_guard_enabled && needToInsertToken) {
		     	document.write('<a class="imagelink" href="javascript:document.htmlform_ldap_settings_%value $index%.submit();" onClick="return confirmDelete(\'%value $index%\');"><img src="icons/delete.png" border="none"></a>');
		       } else {
			document.write('<a class="imagelink" href="ldap-settings.dsp?action=delete&index=%value $index encode(url)%" onClick="return confirmDelete(\'%value $index%\');"><img src="icons/delete.png" border="none"></a>');
		     }
           </script>
    </TD>
   <script>writeTD("rowdata");</script>
   <script>
    ...
    <script>
		        if(is_csrf_guard_enabled && needToInsertToken) {
		     	document.write('<a href="javascript:document.htmlform_ldap_settings1_%value $index%.submit();"><img id = "link_up_%value $index encode(htmlattr)%" src="icons/moveup_enabled.png" border="none"></a>');
		       } else {
			document.write('<a href="ldap-settings.dsp?action=priority&direction=up&index=%value $index encode(url)%"><img id = "link_up_%value $index encode(htmlattr)%" src="icons/moveup_enabled.png" border="none"></a>');
		     }
           </script>
	...
	<script>
		        if(is_csrf_guard_enabled && needToInsertToken) {
		     	document.write('<a href="javascript:document.htmlform_ldap_settings2_%value $index%.submit();"><img id = "link_down_%value $index encode(htmlattr)%" src="icons/movedown_enabled.png" border="none"></a>');
		       } else {
			document.write('<a href="ldap-settings.dsp?action=priority&direction=down&index=%value $index encode(url)%"><img id = "link_down_%value $index encode(htmlattr)%" src="icons/movedown_enabled.png" border="none"></a>');
		     }
           </script> 
