      ...
      <td colspan="2">
        <ul class="listitems">
          ...
          %ifvar isBrokerConfigured equals('true')%
            ...
            <li class="listitem">
			<script>getURL("settings-wm-messaging.dsp?action=error-broker-exists","javascript:document.htmlform_settings_wm_messaging.submit();","Create Broker Connection Alias");</script></li>
          %else%
			<script>
		    createForm("htmlform_settings_wm_broker_create", "settings-wm-broker-create.dsp", "POST", "BODY");
		    </script>
            <li class="listitem">
			<script>getURL("settings-wm-broker-create.dsp","javascript:document.htmlform_settings_wm_broker_create.submit();","Create Broker Connection Alias");</script></li>
          %endif%
		  <script>
    ...
    <tr>
      <td>
        ...
        <table class="tableView" width="100%">
          ...
          <tr>
            <td class="subheading2">Default</td>
            <td class="subheading2">Type</td>
            <td class="subheading2" nowrap>Connection Alias Name</td>
            <td class="subheading2">Description</td>
            <td class="subheading2">CSQ Count</td>
            <td class="subheading2">Enabled</td>
            <td class="subheading2">Delete</td>
          </tr> 
          ...
          %loop aliasDataList%
			...
			document.write('<a href="settings-wm-messaging.dsp?action=changeState&aliasName=%value aliasName encode(url)%&setEnabled=false"><img style="width: 13px; height: 13px;" alt="enabled" border="0" src="images/yellow_check.png">Yes</a>');
		     }
           </script>&nbsp;[Pending&nbsp;Restart]
			...
			document.write('<a href="settings-wm-messaging.dsp?action=changeState&aliasName=%value aliasName encode(url)%&setEnabled=false"><img style="width: 13px; height: 13px;" alt="enabled" border="0" src="images/green_check.png">Yes</a>');
		     }
           </script>&nbsp;[Pending&nbsp;Restart]
                      %endif%
                    %else%
			...
			document.write('<a href="settings-wm-messaging.dsp?action=changeState&aliasName=%value aliasName encode(url)%&setEnabled=false"><img style="width: 13px; height: 13px;" alt="enabled" border="0" src="images/yellow_check.gif">Yes</a>');
		     }
                  ...
                  %else%
					...
					setFormProperty("htmlform_settings_wm_messaging_delete_%value $index%", "aliasName", "%value aliasName encode(url)%");
                      ...
                      %ifvar hasTriggers equals('true')%
                        <script>
		        if(is_csrf_guard_enabled && needToInsertToken) {
		     	document.write('<a href="javascript:document.htmlform_settings_wm_messaging_delete_%value $index%.submit();" onClick="return confirmDelete(\'%value $index%\')"><img style="width: 13px; height: 13px;" alt="active" border="0" src="icons/delete.png"></a>');
		       } else {
			document.write('<a href="settings-wm-messaging.dsp?action=delete&aliasName=%value aliasName encode(url)%" onClick="return confirmDelete(\'%value $index%\')%)"><img style="width: 13px; height: 13px;" alt="active" border="0" src="icons/delete.png"></a>');
		     }
           </script>
                      %else%
                        <script>
		        if(is_csrf_guard_enabled && needToInsertToken) {
		     	document.write('<a href="javascript:document.htmlform_settings_wm_messaging_delete_%value $index%.submit();" onClick="return confirmDelete1(\'%value $index%\')"><img style="width: 13px; height: 13px;" alt="active" border="0" src="icons/delete.png"></a>');
		       } else {
			document.write('<a href="settings-wm-messaging.dsp?action=delete&aliasName=%value aliasName encode(url)%" onClick="return confirmDelete1(\'%value $index%\')"><img style="width: 13px; height: 13px;" alt="active" border="0" src="icons/delete.png"></a>');
		     }
           </script>
                      %endif%
                    %endif%
