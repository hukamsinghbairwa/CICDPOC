					...
					<tr>
						<td>
							 ...
							 %loop authorizationServers%
								<TR>
								 <script>
									 createForm("htmlform_security_oauth_authserver", "security-oauth-authserver.dsp", "POST", "BODY");
									 setFormProperty("htmlform_security_oauth_authserver", "name", "%value name encode(javascript)%");
									 setFormProperty("htmlform_security_oauth_authserver", "action", "edit");
									 writeTD("rowdata");
