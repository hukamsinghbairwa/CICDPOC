...
<!-- Connection Alias -->
        ...
        <table class="tableView" width="100%">
          ...
          <tr>
            ...
            <td class="subheading2">Transaction Type</td>
              ...
              <script>writeTD("rowdata");</script>
                ...
                %else%
                 ...
                 %ifvar hasTriggers equals('true')%
                    <script>
						if(is_csrf_guard_enabled && needToInsertToken) {
						document.write('<a href="javascript:document.htmlform_settings_jms_delete_alias_%value $index%.submit();" onClick="return confirmDelete(\'%value $index%\')"><img style="width: 13px; height: 13px;" alt="active" border="0" src="icons/delete.png"></a>');
					   } else {
					document.write('<a href="settings-jms.dsp?action=delete&aliasName=%value aliasName encode(url)%" onClick="return confirmDelete(\'%value $index%\')"><img style="width: 13px; height: 13px;" alt="active" border="0" src="icons/delete.png"></a>');	
					}	     
					</script>
                  %else%
                    <script>
						if(is_csrf_guard_enabled && needToInsertToken) {
						document.write('<a href="javascript:document.htmlform_settings_jms_delete_alias_%value $index%.submit();" onClick="return confirmDelete1(\'%value $index%\')"><img style="width: 13px; height: 13px;" alt="active" border="0" src="icons/delete.png"></a>');
					   } else {
					document.write('<a href="settings-jms.dsp?action=delete&aliasName=%value aliasName encode(url)%" onClick="return confirmDelete1(\'%value $index%\')"><img style="width: 13px; height: 13px;" alt="active" border="0" src="icons/delete.png"></a>');
					}
				   </script>
                  %endif%
                %endif%
