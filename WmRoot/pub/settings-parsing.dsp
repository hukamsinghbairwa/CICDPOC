          ...
          %invoke wm.server.parsing:getProperties%
            ...
            <tr>
              ...
              %ifvar parserSettings/useBigMemory equals('true')%
				...
				<script>
					if(is_csrf_guard_enabled && needToInsertToken) {
						document.write('<A class="imagelink" HREF="javascript:document.htmlform_settings_parsing_disable_bigmemory.submit();" ONCLICK="return confirmDisable(\'BigMemory caching\');"><IMG SRC="images/green_check.png" border="0" height=13>&nbspYes</A>');
					} else {
						document.write('<A class="imagelink" HREF="settings-parsing.dsp?action=disable&feature=bigmemory" ONCLICK="return confirmDisable(\'BigMemory caching\');"><IMG SRC="images/green_check.png" border="0" height=13>&nbspYes</A>');
					}
				</script>
              ...
              %else%
				...
				<script>
					if(is_csrf_guard_enabled && needToInsertToken) {
						document.write('<A class="imagelink" HREF="javascript:document.htmlform_settings_parsing_enable_bigmemory.submit();" ONCLICK="return confirmEnable(\' BigMemory caching\');">No</A>');
					} else {
						document.write('<A class="imagelink" HREF="settings-parsing.dsp?action=enable&feature=bigmemory" ONCLICK="return confirmEnable(\' BigMemory caching\');">No</A>');
					}
				</script>
