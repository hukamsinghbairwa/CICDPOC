                        ...
                        %else%
                           ...
                           %else%
                               ...
                               %else%
									...
									<script>
										if(is_csrf_guard_enabled && needToInsertToken) {
											document.write('<A class="imagelink" href="javascript:document.htmlform_server_cluster_kill_session_%value $index%.submit();"><IMG src="icons/delete.png" border=0></A>');
										} else {
											document.write('<A class="imagelink" href="server-cluster.dsp?action=kill&sessionID=%value ssnid -urlencode%"><IMG src="icons/delete.png" border=0></A>');
										}
									</script>
