...
<body onLoad="setNavigation('users.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Security_PasswordSecurityScrn');">
  <table width="100%">
    <TR>
      ...
      <TD colspan=2>
        <UL class="listitems">
          ...
          %ifvar doc equals('edit')%
            <li class="listitem">
			<script>getURL("password-settings.dsp","javascript:document.htmlform_password_settings.submit();","View Password Restrictions");</script></li>
          %else%
			<script>
