                          ...
                          <tr>
							   ...
							   <script>
									if(is_csrf_guard_enabled && needToInsertToken) {
										...
										document.write('<a href="security-enterprisegateway-create-rule.dsp?operation=copyRule&ruleType=DENY&rule=%value ruleName encode(url)%&index=%value $index encode(url)%"><img src="icons/copy.gif" border="no"></a>');
									}
								</script>
							   </td>
                               <script>writeTD("rowdata");</script>
								  ...
								  <script>
										if(is_csrf_guard_enabled && needToInsertToken) {
											...
											document.write('<a class="imagelink" href="security-enterprisegateway-rules.dsp?action=delete&index=%value $index encode(url)%&ruleType=DENY&rule=%value ruleName encode(url)%" onclick="return confirmDelete(\'%value ruleName encode(javascript)%\')"> <img src="icons/delete.png" border="none"></a>');
										}
									</script>
                               ...
                               <script>writeTD("rowdata");</script>
									<script>
										if(is_csrf_guard_enabled && needToInsertToken) {
											...
											document.write('<a href="security-enterprisegateway-rules.dsp?action=moveUp&index=%value $index encode(url)%&ruleType=DENY&rule=%value ruleName encode(url)%"><img id = "link_up_deny_%value $index encode(htmlattr)%" src="icons/moveup_enabled.png" border="none"></a>');
										}
									</script>
									<script>
										if(is_csrf_guard_enabled && needToInsertToken) {
											...
											document.write('<a href="security-enterprisegateway-rules.dsp?action=moveDown&index=%value $index encode(url)%&ruleType=DENY&rule=%value ruleName encode(url)%"><img id = "link_down_deny_%value $index encode(htmlattr)%" src="icons/movedown_enabled.png" border="none"></a>');
										}
									</script>
