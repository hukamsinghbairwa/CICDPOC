				  ...
				  setFormProperty("htmlform_service_info_%value $index%", "service", "%value%");
					...
					<script>
						if(is_csrf_guard_enabled && needToInsertToken) {
							document.write('<a href="javascript:document.htmlform_service_info_%value $index%.submit();"><img src="icons/file.png" border=0></a>');
						} else {
							document.write('<a href="service-info.dsp?service=%value encode(url)%"><img src="icons/file.png" border=0></a>');
						}
					</script>
					&nbsp;
					<script>
