                      ...
                      <tr>
                        %invoke wm.server.query:getServerInstanceName%
                            <td valign="top" >
                                ...
                                %else%
									%ifvar productname equals('Microservices Container')%
                        ...
                        %endinvoke%
        <br>
        Copyright &copy; 1996 - 2017 Software AG, Darmstadt, Germany and/or Software AG USA Inc., Reston, VA, USA, and/or its subsidiaries and/or its affiliates and/or their licensors.
        <br><br>
