      ...
      <table style="width: 100%;" class="tableView">
        <tbody>
          ...
          <tr>
            ...
            <td class="subheading2">Active<br><script>getURL("trigger-management-edit-state.dsp?triggerName=all", "javascript:document.htmlform_trigger_management_edit_state.submit();", "edit&nbsp;all");</script>
			</td>      
            <td class="subheading2">Queue Capacity</td>
            <td class="subheading2">Current Queue Count</td>          
            <td class="subheading2">Active<br><script>getURL("trigger-management-edit-state.dsp?triggerName=all", "javascript:document.htmlform_trigger_management_edit_state.submit();", "edit&nbsp;all");</script>
			</td>            
            <td class="subheading2">Processing Mode</td>         
            <td class="subheading2">Maximum Threads</td>
            <td class="subheading2">Current Thread Count</td>   
          </tr>
