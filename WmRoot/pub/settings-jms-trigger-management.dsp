    ...
    <tr>
      ...
      <table width="100%" class="tableView" id="filtercriteria">
         ...
         <tr>
           <td>
             Trigger Name<br>
             <INPUT NAME="triggerFilterValue" size="40" value="%value triggerFilterValue%">
           </td>
           <td>
             Connection Alias Name<br>
             <INPUT NAME="aliasFilterValue" size="40" value="%value aliasFilterValue%">
           </td>
           <td>
             Destinations<br>
             <INPUT NAME="destinationFilterValue" size="40" value="%value destinationFilterValue%">
           </td>
           <td>
...
<!-- Individual Standard JMS Trigger Controls  -->
        ...
        <table width="100%" class="tableView" id="JMS_TABLE">  
          ...
          <tr name="Standard" style="display: table-row;">
            ...
            <td class="subheading2">Status</td>
            <td class="subheading2">Connection Alias Name</td>
            <td class="subheading2" nowrap>Destination(s)</td>
            <td class="subheading2">Processing Mode</td>
            <td class="subheading2">Maximum Threads</td>
            <td class="subHeading2">Current Threads</td>       
          </tr> 
...
<!-- Individual SOAP JMS Trigger Controls  -->
        ...
        <table name="triggerlist" width="100%" class="tableView" id="SOAP_TABLE">  
          ...
          <tr name="SOAP" style="display: table-row;">
            ...
            <td class="subheading2">Processing Mode</td>
            <td class="subheading2">Maximum Threads</td>
            <td class="subHeading2">Current Threads</td>   <!-- we were using oddcol-l -->       
          </tr> 
