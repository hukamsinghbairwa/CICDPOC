    ...
    <tr>
      ...
      <form name='createform' action="settings-jms.dsp" method="post">
        ...
        <table class="tableView" width="100%">
          ...
          <tr>  
            <script>writeTD("row-l");</script>Create Administered Objects On Demand (Universal Messaging)</td>
            <script>writeTD("row-l");</script>
              <input type="checkbox" name="jndi_automaticallyCreateUMAdminObjects">
            </td>
          </tr>
          
          <tr>
            <script>writeTD("row-l");</script>Enable Follow the Master (Universal Messaging)</td>
            <script>writeTD("row-l");</script>
              <input type="checkbox" name="jndi_enableFollowTheMaster" checked=true>
            </td>           
          </tr>
