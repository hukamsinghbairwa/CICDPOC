    ...
    <TR>
      ...
      %loop deny%
          <TR>
			...
			<script>
				if(is_csrf_guard_enabled && needToInsertToken) {
					document.write('<A class="imagelink" HREF="javascript:document.htmlform_server_ipaccess_delete_%value $index%.submit();" ONCLICK="return confirmIt(\'delete\', \'deny\', \'%value encode(javascript)%\');"><IMG SRC="icons/delete.png" alt="Delete this host" border="0"></A>');
				} else {
					document.write('<A class="imagelink" HREF="server-ipaccess.dsp?action=delete&deny=%value encode(url)%" ONCLICK="return confirmIt(\'delete\', \'deny\', \'%value encode(javascript)%\');"><IMG SRC="icons/delete.png" alt="Delete this host" border="0"></A>');
				}
			</script>
            </TD>
          </TR>
      ...
      %case 'exclude'%
          ...
          <TR>
			...
			<script>
				if(is_csrf_guard_enabled && needToInsertToken) {
					document.write('<A class="imagelink" HREF="javascript:document.htmlform_server_ipaccess_return_%value $index%.submit();" ONCLICK="return confirmIt(\'delete\', \'allow\', \'%value encode(javascript)%\');"><IMG SRC="icons/delete.png" alt="Delete this host" border="0"></A>');
				} else {
					document.write('<A class="imagelink" HREF="server-ipaccess.dsp" ONCLICK="return confirmIt(\'delete\', \'allow\', \'%value encode(javascript)%\');"><IMG SRC="icons/delete.png" alt="Delete this host" border="0"></A>');
				}
			</script>
            </TD>
          </TR>
