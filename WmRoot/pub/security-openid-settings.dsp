        ...
        <td>
            <table width="100%">
		        ...
		        if(is_csrf_guard_enabled && needToInsertToken) {
		     	document.write('<a class="imagelink"  href="javascript:document.htmlform_security_openid_settings_%value $index%.submit();" onClick="return deleteProvider(\'%value name%\');"><img src="icons/delete.png" alt="Delete Provider : %value name%" border="none"></a>');
		       } else {
			document.write('<a class="imagelink"  href="security-openid-settings.dsp" onClick="return deleteProvider(\'%value name%\');"><img src="icons/delete.png" alt="Delete Provider : %value name%" border="none"></a>');
		     }
           </script>
                      </TD>
