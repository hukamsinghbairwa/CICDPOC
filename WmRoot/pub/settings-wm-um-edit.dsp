          ...
          <TR>
            ...
            <TD class="oddrowdata-l">
              %ifvar um_followTheMasterForPublish equals(true)%
                <INPUT TYPE="checkbox" NAME="um_followTheMasterForPublish" checked="true">
              %else%
                <INPUT TYPE="checkbox" NAME="um_followTheMasterForPublish">
              %endif%
            </TD>
          </TR>
          ...
          <TR>
            ...
            <TD class="oddrowdata-l">
              %ifvar um_followTheMasterForSubscribe equals(true)%
                <INPUT TYPE="checkbox" NAME="um_followTheMasterForPublish" checked="true">
              %else%
                <INPUT TYPE="checkbox" NAME="um_followTheMasterForSubscribe">
              %endif%
            </TD>
          </TR>
