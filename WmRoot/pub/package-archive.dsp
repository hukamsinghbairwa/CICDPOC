...
%end if%
        ...
        <TR>
          <TD><TABLE class="tableView width50">
              ...
              <TR>
          <td class="evenrow-l" colspan="3">Files available in %value package encode(html)%:</td></tr>
                    <TR class="fullinputwidth">
                      <TD class="evenrow-l" colspan="3" width="100%">
                      %invoke wm.server.replicator:packageFileList%
                        <SELECT name="file" size="24" multiple width="100%">
      ...
      <tr>
              ...
              <TD valign=top colspan="2" style="margin: 0; padding: 0; border-collapse: collapse;">
                  <TABLE style="margin: 0; padding: 0; width: 100%; border-collapse: collapse;">
                    <tr><td class="oddrow file-selection" style="text-align: left;">
                      <INPUT type="radio" name="filter" value="includeall" checked onClick="SelectByID('archive-type-full')">All files</td></tr>
                    <tr><td class="oddrow file-selection" style="text-align: left;">
                        <INPUT type="radio" name="filter" value="include" onClick="SelectByID('archive-type-partial')">Selected files</td></tr>
                    <tr><td class="oddrow file-selection" style="text-align: left;">
                        <INPUT type="radio" name="filter" value="exclude" onClick="SelectByID('archive-type-partial')">All <i>except</i> selected files</td></tr>
                    <tr><td class="oddrow file-selection" style="text-align: left;">
                        <INPUT type="radio" name="filter" value="include" onClick="SelectByID('archive-type-partial')">Files specified by filter:<br>
                        <INPUT name="includepattern">
                    </td></tr>
                    <tr><td class="oddrow file-selection" style="text-align: left;>
                        <INPUT type="radio" name="filter" value="exclude" onClick="SelectByID('archive-type-partial')">All <i>except</i> files specified by filter:<br>
              ...
              <tr>
                ...
                <input type="text" style="width:100%;" wrap="off" name="files_to_delete" cols="35"></input>
                </td>
              </tr>
              ...
              <TR>
                ...
                <TD class="oddrow-l" colspan="2" nowrap>
                  <INPUT type="radio" id="archive-type-full" name="type" value="full" checked>Full <font style="font-weight: normal;">(Including all files is recommended)</font><br>
                  <INPUT type="radio" id="archive-type-partial" name="type" value="partial">Patch <font style="font-weight: normal;">(For distributing upgrades)</font>
                  </TD>
              </TR>
              <TR>
                %ifvar release%
