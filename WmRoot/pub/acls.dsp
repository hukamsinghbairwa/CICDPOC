    ...
    <tr>
      <TD colspan="2">
		...
		<script>
          ...
          <li class="listitem">
		  <script>getURL("acl-addremove.dsp","javascript:document.htmlform_http_acl_addremove.submit();","Add and Remove ACLs");
		  </script>
		  </li>
        </ul>
      </td>
    ...
    <input type="hidden" name="precedence" value="deny">
      ...
      <td>
		...
		<script>
           ...
           <a style="text-decoration: none" class="submodal" href="subGroupLookup"><input onclick="oTo=allowList" type="button" value="Add"></a>
                  ...
                  <tr><td class="oddcol" align="right">
                  <a style="text-decoration: none" class="submodal" href="subGroupLookup"><input onclick="oTo=denyList" type="button" value="Add"></a>
