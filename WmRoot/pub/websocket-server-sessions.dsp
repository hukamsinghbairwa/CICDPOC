...
<HTML>
  ...
  <body onLoad="emptySessionIdArray(); setNavigation('websocket-server-sessions.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Security_WebSocket_ServerSessionsScrn');">
    <TABLE width="100%">
      <TR>
...
%endif%
	...
	<TR>
        <TD>
		  ...
		  <INPUT type="hidden" name="webSocketURI" value="%value -urldecode webSocketURI%">
		  <INPUT type="hidden" name="port" value="%value port%">
		  
          <TABLE class="tableView">
            <TR>
              <td class="heading" colspan="7">Active Sessions - %value -urldecode webSocketURI%</td>
            </TR>
			...
			%else%
			<TR>
              <td span style="font-weight:bold" class="oddcol" colspan="7">No Active Sessions found for WebSocket Endpoint URI %value -urldecode webSocketURI%</td>
            </TR>
            %endif%
			%endinvoke%
