        ...
        <td>
            <table width="100%">
		        ...
		        if(is_csrf_guard_enabled && needToInsertToken) {
		     	document.write('<A class="imagelink" HREF="javascript:document.htmlform_keystore_management_%value $index%.submit();"  ONCLICK="return confirmReload(\'%value keyStoreName encode(javascript)%\', \'key\');"><IMG SRC="icons/icon_reload.png" border="0"alt="Reload Keystore"></A>');
		       } else {
			document.write('<A class="imagelink" HREF=""  ONCLICK="return confirmReload(\'%value keyStoreName encode(javascript)%\', \'key\');"><IMG SRC="icons/icon_reload.png" border="0"alt="Reload Keystore"></A>');
		     }
           </script>
                      ...
                      <script>writeTD("rowdata");</script>               
                          <script>
		        if(is_csrf_guard_enabled && needToInsertToken) {
		     	document.write('<a class="imagelink"  href="javascript:document.htmlform_keystore_management_%value $index%.submit();" onClick="return deleteKeyStore(\'%value keyStoreName encode(javascript)%\',\'key\');"><img src="icons/delete.png" alt="Delete Keystore : %value keyStoreName encode(htmlattr)%" border="none"></a>');
		       } else {
			document.write("<a class='imagelink'  href='security-keystoremgt.dsp' onClick='return deleteKeyStore(\"%value keyStoreName encode(javascript)%\",\"key\");'><img src='icons/delete.png' alt='Delete Keystore : %value keyStoreName encode(htmlattr)%' border='none'></a>");
		     }
           </script>
                      </TD>
                ...
                %invoke wm.server.security.keystore:listTrustStores%
                      ...
                      %loop trustStores%
						  ...
						  <script>
		        if(is_csrf_guard_enabled && needToInsertToken) {
		     	document.write('<A class="imagelink" HREF="javascript:document.htmlform_keystore_management.submit();"  ONCLICK="return confirmReload(\'%value keyStoreName encode(javascript)%\', \'trust\');"><IMG SRC="icons/icon_reload.png" border="0"alt="Reload Truststore"></A>');
		       } else {
			document.write('<A class="imagelink" HREF=""  ONCLICK="return confirmReload(\'%value keyStoreName encode(javascript)%\', \'trust\');"><IMG SRC="icons/icon_reload.png" border="0"alt="Reload Truststore"></A>');
		     }
           </script>
				</TD>                                                                                         
                            ...
                            <script>writeTD("rowdata");</script>               
								...
								<script>
		        if(is_csrf_guard_enabled && needToInsertToken) {
		     	document.write('<a class="imagelink" href="javascript:document.htmlform_keystore_management.submit();" onClick="return deleteKeyStore(\'%value keyStoreName encode(javascript)%\',\'trust\');"><img src="icons/delete.png" alt="Delete Truststore : %value keyStoreName encode(htmlattr)%" border="none"></a>');
		       } else {
			document.write('<a class="imagelink" href="security-keystoremgt.dsp" onClick="return deleteKeyStore(\'%value keyStoreName encode(javascript)%\',\'trust\');"><img src="icons/delete.png" alt="Delete Truststore : %value keyStoreName encode(htmlattr)%" border="none"></a>');
		     }
           </script>
                            </TD>
