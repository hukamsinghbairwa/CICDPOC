                        ...
                        <table class="tableView" width="100%">
							...
							<tbody>
								...
								<tr>
									...
									<td class="oddrow-l" width="70%">
										<input type="radio" name="strictHostKeyChecking" value="yes" checked> Yes
								    	 &nbsp;<input type="radio" name="strictHostKeyChecking" value="no" %ifvar strictHostKeyChecking equals('no')%checked%endif%> No
									</td>
								</tr>
								<tr>
									<td class="evenrow" width="30%">Compression</td>	
									<td class="evenrow-l" width="70%">
								...
								<tr>
									<td class="oddrow" width="30%">Compression Level</td>	
									<td class="oddrow-l" width="70%">
										%ifvar operation equals('add')%
