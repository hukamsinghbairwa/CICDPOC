  ...
  <head>
	...
	function enablePackage(package_name) {
		if(is_csrf_guard_enabled && needToInsertToken) {
			document.write('<A class="imagelink" HREF="javascript:document.pkg_list_pkg_enable.submit();" ONCLICK="return confirmEnableForm(\''+package_name+'\', document.pkg_list_pkg_enable, \'action=enable;package='+package_name+'\');"><IMG border="0" SRC="images/blank.gif" height=13 width=13>No</A>');
		} else {
			document.write('<A class="imagelink" HREF="package-list.dsp?action=enable&package='+package_name+'" ONCLICK="return confirmEnable(\''+package_name+'\');"><IMG border="0" SRC="images/blank.gif" height=13 width=13>No</A>');
		}
	}

	function disablePackage(package_name) {
		if(is_csrf_guard_enabled && needToInsertToken) {
			document.write('<A class="imagelink" HREF="javascript:document.pkg_list_pkg_disable.submit();" ONCLICK="return confirmDisableForm(\''+package_name+'\', document.pkg_list_pkg_disable, \'action=disable;package='+package_name+'\');"><IMG SRC="images/green_check.png" border="0" height=13 width=13>Yes</A>');
		} else {
			document.write('<A class="imagelink" HREF="package-list.dsp?action=disable&package='+package_name+'" ONCLICK="return confirmDisable(\''+package_name+'\');"><IMG SRC="images/green_check.png" border="0" height=13 width=13>Yes</A>');
		}
	}
     ...
     %invoke wm.server.packages:packageList%
        ...
        <table class="tableView" width="100%" id="head" name="head">
          ...
          <TR class="subheading2">
            ...
            <TR >
               ...
               <script>writeTD('rowdata');</script>
					...
					<script>
						if(is_csrf_guard_enabled && needToInsertToken) {
							document.write('<A class="imagelink" HREF="javascript:document.pkg_list_pkg_reload.submit();"  ONCLICK="return confirmReloadForm(\'%value name encode(javascript)%\',\'%value pkgType encode(javascript)%\', document.pkg_list_pkg_reload, \'action=reload;package=%value name%\');">                  <IMG SRC="icons/icon_reload.png" border="0" alt="Reload Package"></A>');
						} else {
							document.write('<A class="imagelink" HREF="package-list.dsp?action=reload&package=%value name encode(url)%"  ONCLICK="return confirmReload(\'%value name encode(javascript)%\',\'%value pkgType encode(javascript)%\');"><IMG SRC="icons/icon_reload.png" border="0" alt="Reload Package"></A>');
						}
					</script>
                  </TD>
               <script>writeTD('rowdata');</script>
         ...
         <script>writeTD('rowdata');</script>
					...
					<script>
						if(is_csrf_guard_enabled && needToInsertToken) {
							document.write('<A class="imagelink"  HREF="javascript:document.pkg_list_pkg_archive.submit();" onClick="return populateForm(document.pkg_list_pkg_archive, \'package=%value name%;archive=true\')"><IMG src="images/archive_package.png" border=0 width=43 height=16></A>');
						} else {
							document.write('<A class="imagelink"  HREF="package-archive.dsp?package=%value name encode(url)%&archive=true"><IMG src="images/archive_package.png" border=0 width=43 height=16></A>');
						}
					</script>
                  </TD>
         </td>
               <script>writeTD('rowdata');</script>
					...
					<script>
						if(is_csrf_guard_enabled && needToInsertToken) {
							document.write('<A class="imagelink"  HREF="javascript:document.pkg_list_pkg_safe_delete.submit();" onclick="return confirmDeleteForm(\'%value name encode(javascript)%\', \'true\', document.pkg_list_pkg_safe_delete, \'action=delete;package=%value name%;safeDelete=checked\');"><IMG src="images/safe_delete.png" border=0 width=43 height=16></A>');
						} else {
							document.write('<A class="imagelink"  HREF="package-list.dsp?action=delete&package=%value name encode(url)%&safeDelete=checked" onclick="return confirmDelete(\'%value name encode(javascript)%\', \'true\');"><IMG src="images/safe_delete.png" border=0 width=43 height=16></A>');
						}
					</script>
                  </TD>
               <script>writeTD('rowdata');swapRows();</script>
					...
					<script>
						if(is_csrf_guard_enabled && needToInsertToken) {
							document.write('<A class="imagelink" HREF="javascript:document.pkg_list_pkg_delete.submit();" onclick="return confirmDeleteForm(\'%value name encode(javascript)%\', \'false\', document.pkg_list_pkg_delete, \'action=delete;package=%value name%\');"><IMG SRC="icons/delete.png" alt="Delete this Package" border="0"></A>');
						} else {
							document.write('<A class="imagelink" HREF="package-list.dsp?action=delete&package=%value name encode(url)%" onclick="return confirmDelete(\'%value name encode(javascript)%\', \'false\');"><IMG SRC="icons/delete.png" alt="Delete this Package" border="0"></A>');
						}
					</script>
                  </TD>
            </TR> %endloop%
