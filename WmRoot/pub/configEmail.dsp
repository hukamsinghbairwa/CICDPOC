          ...
          <tr>
            ...
            <td class="%ifvar ../mode equals('view')%oddrowdata-l%else%oddrow-l%endif%">
              ...
              %else%
				...
				<a class="submodal" style="display:inline" id=subUserSearchlink href="subUserLookup"><img border=0 align="bottom" src="icons/magnifyglass.gif"/></a>  
	    			%else%
	    				<a class="submodal" style="display:none" id=subUserSearchlink href="subUserLookup"><img border=0 align="bottom" src="icons/magnifyglass.gif"/></a>  
