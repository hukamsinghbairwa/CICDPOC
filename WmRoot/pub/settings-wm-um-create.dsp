    ...
    <TR>
	  ...
	  <table class="tableView" width="85%">	  
          ...
          <TR>
            ...
            <TD class="oddrowdata-l"><INPUT TYPE="checkbox" NAME="um_followTheMasterForPublish" checked="true"></TD>
          </TR>
	  ...
	  <table class="tableView" width="85%">
          ...
          <!-- Follow the Master -->
          <TR>
            <TD class="evenrow-l">Enable Follow the Master for Consumers</TD>
            <TD class="evenrowdata-l"><INPUT TYPE="checkbox" NAME="um_followTheMasterForSubscribe" checked="true"></TD>
          </TR> 
