            ...
            <FORM name="shutdownform" method="POST" action="server-shutdown.dsp">
              ...
              <TR>
                <TD class="oddrow-l" style="border-right: none">
                  <INPUT type="radio" onclick="drain=true;"  name="option" value="drain" checked>
                  After all client sessions end...</td>
                <td class="oddrow" style="border-left: none"> Maximum wait time:
                  <INPUT name="timeout" value="%value watt.server.clientTimeout encode(htmlattr)%" size=3 onchange="verifyInteger(this.value);"></INPUT>
                  minutes</TD>
              </TR>
