   ...
   <TR>
    ...
    <TR>
      ...
      <SCRIPT>writeTD("rowdata");</SCRIPT>
		...
		<script>
		        if(is_csrf_guard_enabled && needToInsertToken) {
		     	document.write('<A href="javascript:document.deleteform.submit();" onClick="return populateForm(document.deleteform, \'action=test;aliasName=%value aliasName%;stage=%value stage%\')"><IMG src="../WmRoot/icons/checkdot.gif" border="none"></A>');
		       } else {
			document.write('<A href="integration-live.dsp?action=test&aliasName=%value aliasName encode(url)%&stage=%value stage encode(url)%"><IMG src="../WmRoot/icons/checkdot.gif" border="none"></A>');
		     }
           </script>
      </TD>
	  ...
	  %switch isEnabled%
		...
		<script>
		        if(is_csrf_guard_enabled && needToInsertToken) {
		     	document.write('<a href="javascript:document.deleteform.submit();" onClick="return populateForm(document.deleteform, \'action=disable;aliasName=%value aliasName%;stage=%value stage%\')"><img style="width: 13px; height: 13px;" alt="enabled" border="0" src="../WmRoot/images/green_check.gif">Yes</a>');
		       } else {
			document.write('<a href="integration-live.dsp?action=disable&aliasName=%value aliasName encode(url)%&stage=%value stage encode(url)%"><img style="width: 13px; height: 13px;" alt="enabled" border="0" src="../WmRoot/images/green_check.gif">Yes</a>');
		     }
           </script>
		%case 'false'%
